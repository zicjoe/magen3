...
export const INTENT_SCHEMA_DESCRIPTION = {
  ...
  threatIntelligence: "Magen3 screens chain-aware wallets, contracts, asset contracts, domains, URL origins, RPC endpoints, routers, bridge/payment counterparties, and resource providers against freshness-checked operator feeds and enabled server-controlled provider adapters. Provider evidence is normalized; Magen3 policy remains the deterministic decision authority.",
