  ...
  try {
    ...
    if (route === "GET /api/public-config") {
      ...
      return send(res, 200, {
        ...
        complianceControls,
        integrationContract: {
          sdkPackage: "@magen3/sdk",
          sdkChannel: "beta",
          installCommand: "pnpm add @magen3/sdk@beta",
          environmentVariables: {
            gatewayUrl: "MAGEN3_GATEWAY_URL",
            agentId: "MAGEN3_AGENT_ID",
            apiKey: "MAGEN3_API_KEY",
          },
          gatewayUrlMeaning: "Magen3 API base URL only. Do not append /api/agent-gateway/intents or another route.",
          legacyApiKeyAliases: ["MAGEN3_AGENT_KEY", "MAGEN3_AGENT_API_KEY"],
        },
        gateway: {
    ...
    if (route === "GET /api/agent-gateway/spec") {
      return send(res, 200, {
        ...
        integrationContract: {
          ...
          gatewayUrlMeaning: "Base URL only, for example https://magen3-production.up.railway.app",
          apiKeyHeader: "x-magen3-agent-key",
          legacyApiKeyAliases: ["MAGEN3_AGENT_KEY", "MAGEN3_AGENT_API_KEY"],
        },
